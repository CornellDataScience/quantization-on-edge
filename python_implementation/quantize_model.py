...
def quantize_log(prep_model_path, quantized_params_path, quantized_activations_path, quantized_biases_path, output_model_path):
    '''
    Quantize ONNX model (using logarithmic quantization scheme) and save quantized model
