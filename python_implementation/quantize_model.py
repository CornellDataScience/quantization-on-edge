...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        ...
        #     quantize_asymmetric(prep_model_path, quantized_params_path, quantized_activations_path, quantized_biases_path, output_model_path)
            ...
            output_prep_model_path = "models/prep_cnn_model.onnx"
            prepare(onnx_model_path, quantized_params_path, output_prep_model_path)

        elif mode == "cnn_symmetric":
            prep_model_path = "models/prep_cnn_model.onnx"
            quantized_params_path = "params/quantized_params_cnn.json"
            quantized_activations_path = "activations/quantized_activations_cnn.json"
            quantized_biases_path = "biases/quantized_biases_cnn.json"
            output_model_path = "models/quantized_cnn_model.onnx"
            quantize_cnn(prep_model_path, quantized_params_path, quantized_activations_path, quantized_biases_path, output_model_path)